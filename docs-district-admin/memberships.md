...
![School Board Members tab showing users, membership roles, dates, and View member operations.](assets/screenshots/SB-DST-014-group-members.annotated.png){ .doc-screenshot }
...
![Add Group membership form with User autocomplete, URL alias, Group Admin role, and Save identified.](assets/screenshots/SB-DST-016-add-member-dialog-annotated.png){ .doc-screenshot }
...
![Group Members list with the Operations menu expanded to show View member, Edit member, and Remove member.](assets/screenshots/SB-DST-017-edit-member-dialog-clean.png){ .doc-screenshot }

*Figure SB-DST-017. Open the membership Operations menu.*

![Edit group membership page with Group Admin role and Save controls identified.](assets/screenshots/SB-DST-018-edit-member-dialog-annotated.png){ .doc-screenshot }
...
![Remove membership confirmation with Delete and Cancel controls identified.](assets/screenshots/SB-DST-020-remove-group-member-dialog-annotated.png){ .doc-screenshot }
