...
District Administrators can edit an agenda only when they are also assigned as a Group Administrator for the Group that owns it.
...
![Status message confirming that the agenda is locked against simultaneous editing and remains locked if the editor leaves without saving or unlocking.](assets/screenshots/SB-AAC-021-form-locked-for-editing.png){ .doc-screenshot }
...
![Warning explaining that another user is editing the agenda and showing how long the lock has been active.](assets/screenshots/SB-AAC-022-form-locked-warning.png){ .doc-screenshot }
...
![Save, Preview, Unlock, and Delete buttons at the bottom of the agenda Edit form.](assets/screenshots/SB-AAC-023-form-unlocked-button.png){ .doc-screenshot }
...
![Confirmation message stating that the content is unlocked and anyone can now edit it.](assets/screenshots/SB-AAC-024-form-unlock-message.png){ .doc-screenshot }
...
- [District Administrator responsibilities](responsibilities.md)
