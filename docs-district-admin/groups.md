...
![Groups page with Add group, group list columns, and Operations controls identified.](assets/screenshots/SB-DST-012-groups-annotated.png){ .doc-screenshot }
...
![Add Group screen showing the available group types.](assets/screenshots/SB-DST-025-add-group-type.png){ .doc-screenshot }

*Figure SB-DST-025. Select the group type carefully; it cannot be changed later.*

3. Enter the approved group name and details.

![Add Group form for the group home-page information.](assets/screenshots/SB-DST-026-add-group-home-page.png){ .doc-screenshot }

*Figure SB-DST-026. Enter the approved group home-page information.*

4. Save and verify the group.

![Save controls on the Add Group form.](assets/screenshots/SB-DST-027-add-group-save.png){ .doc-screenshot }
