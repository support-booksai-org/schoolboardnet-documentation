...
![People page with Add user, filters, account list, Edit operations, and bulk-action menu identified.](assets/screenshots/SB-DST-004-people-annotated.png){ .doc-screenshot }
