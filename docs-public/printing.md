---
title: Print an agenda
description: Print an agenda-only view or the available public packet.
---
...
- Review the browser print preview before printing or saving as PDF.
- Use browser zoom to enlarge text for on-screen reading.

![Accordion Agenda with Print Full Packet and Print Agenda Only controls.](assets/screenshots/SB-PUB-011-printer-friendly-control-v01.png){ .doc-screenshot }
