---
title: My Account
description: Review account information, change an email address or password, and sign out.
...
![Signed-in My Account page with View, Newsletters, and Edit tabs and an account summary.](assets/screenshots/SB-BRD-022-my-account-overview.png){ .doc-screenshot }
...
![Edit account page with current password, email address, new password, confirmation, and Save controls.](assets/screenshots/SB-BRD-023-edit-account-settings.png){ .doc-screenshot }
