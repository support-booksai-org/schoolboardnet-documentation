...
![Password reset form requesting a username or email address.](assets/screenshots/SB-BRD-005-password-reset-form.png){ .doc-screenshot }

*Figure SB-BRD-005. Password reset request.*

![Generic password reset confirmation with no account information displayed.](assets/screenshots/SB-BRD-006-password-reset-confirmation.png){ .doc-screenshot }
