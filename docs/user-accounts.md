...
![Add user form with email, username, password, confirmation, status, notification, optional settings, and Create new account controls identified.](assets/screenshots/SB-DST-006-add-user-form-annotated.png){ .doc-screenshot }
...
![Edit user page with email, username, password, status, Save, and Cancel account controls identified.](assets/screenshots/SB-DST-008-edit-user-form-annotated.png){ .doc-screenshot }
