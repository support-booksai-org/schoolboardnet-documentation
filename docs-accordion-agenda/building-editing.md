...
![Add Accordion Section control.](assets/images/SB-AAC-011-add-accordian-section-button.png){ .doc-screenshot }
...
![New Accordion Section with a title, Agenda Item, and file areas.](assets/images/SB-AAC-011-create-accordion-section.png){ .doc-screenshot }
...
![Saved Building Committee Accordion Section.](assets/images/SB-AAC-011-view-accordion-section.png){ .doc-screenshot }
...
![Accordion Section editor showing nested Agenda Items and the Add menu.](assets/images/SB-AAC-003-clone-me-accordion-section.png){ .doc-screenshot }
...
![Agenda Item editor identifying its primary fields.](assets/images/SB-AAC-004-clone-me-edit-agenda-item.png){ .doc-screenshot }
...
![Expandable HTML editor with numbered controls.](assets/images/SB-AAC-005-clone-me-edit-html-item.png){ .doc-screenshot }
...
![Building Committee section selected for reordering.](assets/images/SB-AAC-012-reorder-section-select.png){ .doc-screenshot }

*Figure SB-AAC-012A. Select the section's drag handle.*

![Building Committee section moved upward.](assets/images/SB-AAC-012-reorder-section-drag-up.png){ .doc-screenshot }
...
![Accordion Section actions menu showing Remove and Duplicate.](assets/images/SB-AAC-013-duplicate-remove.png){ .doc-screenshot }
...
![Completed expanded section with Agenda Item content and a public file.](assets/images/SB-AAC-014-completed-agenda-item.png){ .doc-screenshot }
