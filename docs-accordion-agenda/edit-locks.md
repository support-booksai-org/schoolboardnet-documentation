...
If another administrator tries to edit the same agenda, a warning identifies:

- the user who currently has the agenda locked; and
...
- [Accordion Agenda best practices](best-practices.md)
