...
![Add Group membership form with User autocomplete, URL alias, role, and Save identified.](assets/screenshots/SB-DST-016-add-member-dialog-annotated.png){ .doc-screenshot }
