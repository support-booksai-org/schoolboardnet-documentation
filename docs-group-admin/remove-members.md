...
![Group Members list with the Operations menu showing View member, Edit member, and Remove member.](assets/screenshots/SB-DST-017-edit-member-dialog-clean.png){ .doc-screenshot }
